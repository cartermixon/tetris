...
var sidebar = function() {
    ...
    // pause button using button object class
    if(paused === false) {
        var Button = function(config) {
            this.x = config.x || 0;
            this.y = config.y || 0;
            this.width = config.width || 166;
        ...
        Button.prototype.draw = function() {
            ...
            fill(26, 18, 26);
            text(this.label, this.x+50, this.y+this.height/1.3);
        };
    ...
    // unpause button using button object class
    else {
        var Button = function(config) {
            this.x = config.x || 0;
            this.y = config.y || 0;
        ...
        Button.prototype.draw = function() {
            ...
            rect(this.x, this.y, this.width, this.height, 5);
            fill(26, 18, 26);
            text(this.label, this.x+40, this.y+this.height/1.3);
        };
        var unpauseButton = new Button({
            x: 15,
            y: 332,
            label: "Continue"
        });
...
var draw = function() { 
    ...
    if(mouseIsPressed && 
        ...
        mouseX > 15 && mouseX < 180 &&
        mouseY > 333 && mouseY < 358) 
    {   
        paused = !paused;
